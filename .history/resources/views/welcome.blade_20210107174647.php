...
@section('content')
    <div class="showcase-universal">
        ...
        <div class="indicators">
            <ol style="list-style-type: none" class="d-flex flex-row nav navbar-right">
                ...
                <li class="li-indicator">
                    <div class="row align-items-center">
                        <img class="col-4 rounded-circle img-fluid" style="height:auto;" src="{{asset('img/front/1002.jpg')}}" alt="">
                        <div class="col-8">
                            <div class="flex-column">
                                <h3 class="text-center">PRODUCT NAME</h3>
                                <h6 class="text-center font-weight-bolder">KES 5,000</h6>
